    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-7">
            ...
            <div class="text-center mb-5">
                ...
                <h2 class="fw-bold text-primary mb-2">{{ __('Editar Usuario') }}</h2>
                <p class="text-muted mb-0">{{ __('Modifica la información del usuario') }}: <strong>{{ $user->name }}</strong></p>
            </div>

            <!-- Form Card -->
            <div class="card border-0 shadow-lg form-card">
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('usuarios.update', ['usuario' => $user->id]) }}" class="edit-form">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <select name="rol_id" 
                                    ...
                                    <option value="administrador" @if($user->rol_id=="administrador") selected @endif>{{ __('Administrador') }}</option>
                                    <option value="editor" @if($user->rol_id=="editor") selected @endif>{{ __('Editor') }}</option>
                                    <option value="lector" @if($user->rol_id=="lector") selected @endif>{{ __('Lector') }}</option>
                                </select>
                            </div>
                            @error('rol_id')
                                <div class="invalid-feedback d-block mt-2">
