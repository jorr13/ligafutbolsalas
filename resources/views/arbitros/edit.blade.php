                    ...
                    <form action="{{ route('arbitros.update', $arbitro) }}" 
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="estatus" id="estatus" class="form-select @error('estatus') is-invalid @enderror" required>
                                <option value="activo" {{ old('estatus', $arbitro->estatus) == 'activo' ? 'selected' : '' }}>{{ __('Activo') }}</option>
                                <option value="inactivo" {{ old('estatus', $arbitro->estatus) == 'inactivo' ? 'selected' : '' }}>{{ __('Inactivo') }}</option>
                                <option value="sancionado" {{ old('estatus', $arbitro->estatus) == 'sancionado' ? 'selected' : '' }}>{{ __('Sancionado') }}</option>
                            </select>
                            @error('estatus')
                                <div class="invalid-feedback d-block mt-2"><strong>{{ $message }}</strong></div>
                            @enderror
                        </div>
                        <div class="form-group mb-4 {{ old('estatus', $arbitro->estatus) == 'sancionado' ? '' : 'd-none' }}" id="wrap-fecha-fin-sancion-arbitro">
                            ...
                            <input type="date" name="fecha_fin_sancion" id="fecha_fin_sancion"
                                   ...
                                   value="{{ old('fecha_fin_sancion', $arbitro->fecha_fin_sancion ? $arbitro->fecha_fin_sancion->format('Y-m-d') : '') }}">
