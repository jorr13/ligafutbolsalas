...
<div class="container-fluid py-4">
    ...
    <div class="row g-4" style="justify-content: center;">
        @if(auth()->user()->rol_id=="entrenador")
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <a href="{{ route('comentarios.index') }}" class="card h-100 border-0 shadow-sm text-decoration-none quick-action-card">
                    <div class="card-body text-center p-4">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <a href="{{ route('comentarios.index') }}" class="card h-100 border-0 shadow-sm text-decoration-none quick-action-card">
                    <div class="card-body text-center p-4">
                        ...
                        <h5 class="card-title mb-2 fw-bold">Comentarios</h5>
                        <p class="text-muted small mb-0">Moderar comentarios</p>
                    </div>
                </a>
            </div>
        @endif
