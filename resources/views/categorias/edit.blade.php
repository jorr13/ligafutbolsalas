    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-7">
            ...
            <div class="text-center mb-5">
                ...
                <h2 class="fw-bold text-primary mb-2">{{ __('Editar Categoría') }}</h2>
                <p class="text-muted mb-0">{{ __('Modifica la información de la categoría') }}: <strong>{{ $categorias->nombre }}</strong></p>
            </div>
