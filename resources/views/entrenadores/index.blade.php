...
<style>
    ...
    @media (max-width: 768px) {
        ...
        /* Ocultar: Cédula(2), Contacto(3), Dirección(4) */
    ...
    @media (max-width: 576px) {
        ...
        /* Ocultar también Club(5) */
        .table th:nth-child(5),
        .table td:nth-child(5) {
            display: none;
        }

        .table td:last-child { min-width: 110px; }
        ...
        <div class="pagination-container">
            <div class="pagination-wrapper">
                <div class="pagination-info">
                    Mostrando {{ $entrenadores->firstItem() }} a {{ $entrenadores->lastItem() }} de {{ $entrenadores->total() }} entrenadores
                </div>
                <div class="pagination-box">
                    {{ $entrenadores->appends(request()->query())->links('pagination::bootstrap-4') }}
                </div>
            </div>
        </div>
        @endif
